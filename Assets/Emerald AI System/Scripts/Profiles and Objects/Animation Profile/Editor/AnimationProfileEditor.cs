...
namespace EmeraldAI.Utility
{
    ...
    public class AnimationProfileEditor : Editor
    {
        ...
        SerializedProperty Type1CombatAnimationsFoldout, Type2CombatAnimationsFoldout, Type1EquipsFoldout, Type2EquipsFoldout, Type1AttacksFoldout, Type2AttacksFoldout, Type1IdleFoldout, Type2IdleFoldout, NonCombatAnimationsFoldout, NonCombatIdleFoldout, NonCombatDeathFoldout,
           AnimatorSettingsFoldout, NonCombatHitFoldout, Type1HitFoldout, Type2HitFoldout, Type1BlockFoldout, Type2BlockFoldout, Type1DeathFoldout, Type2DeathFoldout, NavMeshLinkAnimationsFoldout;
        ...
        void InitializeProperties()
        {
            ...
            NavMeshLinkAnimationsFoldout = serializedObject.FindProperty("NavMeshLinkAnimationsFoldout");
        ...
        void Type1AttackAnimations(AnimationProfile self)
        {
            ...
            if (Type1AttacksFoldout.boolValue)
            {
                ...
                "Please refer to Emerald's documentation for a tutorial on how to do this.", "https://black-horizon-studios.gitbook.io/emerald-ai-wiki/emerald-managers/animation-viewer-manager/creating-attack-animation-events");
        ...
        void Type1CoverAnimations(AnimationProfile self)
        {
            ...
            if (Type1CoverFoldout.boolValue)
            {
                ...
                CustomEditorProperties.ImportantTutorialButton("Note: An AI needs to have a Cover Component and have Cover Nodes set up in order to use its cover animations." +
                    "Please refer to Emerald's documentation for a tutorial on how to do this, if you haven't already done so.", "https://black-horizon-studios.gitbook.io/emerald-ai-wiki/emerald-components-optional/cover-component");
        ...
        void NavMeshLinkAnimations(AnimationProfile self)
        {
            NavMeshLinkAnimationsFoldout.boolValue = EditorGUILayout.Foldout(NavMeshLinkAnimationsFoldout.boolValue, "NavMesh Link Animations", true, FoldoutStyle);

            if (NavMeshLinkAnimationsFoldout.boolValue)
            {
                CustomEditorProperties.BeginFoldoutWindowBox();
                CustomEditorProperties.TextTitleWithDescription("NavMesh Link Animations", "Controls all animations for AI using NavMesh Links.", false);
                CustomEditorProperties.ImportantTutorialButton("Note: AI will need to have an Emerald NavMesh Link component attached in order for them to use the NavMesh Link animations.", "https://black-horizon-studios.gitbook.io/emerald-ai-wiki/emerald-components-optional/navmesh-link-component");
                //Jump
                CustomEditorProperties.DrawAnimationClassVariables(self, self.NavMeshLinkAnimations.Jump, "Jump", "The animation that plays when the AI is jumping when using a NavMesh Link.", 2, false, false);
                //Land
                CustomEditorProperties.DrawAnimationClassVariables(self, self.NavMeshLinkAnimations.Land, "Land", "The animation that plays when the AI is landing after a NavMesh Link.", 2, false, false);
                //Drop
                CustomEditorProperties.DrawAnimationClassVariables(self, self.NavMeshLinkAnimations.Drop, "Drop", "The animation that plays when the AI is dropping from a NavMesh Link.", 2, false, false);
                //Vault
                CustomEditorProperties.DrawAnimationClassVariables(self, self.NavMeshLinkAnimations.Vault, "Vault", "The animation that plays when the AI is vaulting when using a NavMesh Link.", 2, false, false);
                CustomEditorProperties.EndFoldoutWindowBox();
            }
        }
        ...
        {
            //TODO: Instead of checking all animations, only check essential ones.
