...
namespace EmeraldAI.Utility
{
    ...
    public class EmeraldAbilityObjectEditor : Editor
    {
        ...
        SerializedProperty MeleeSettings, ProjectileSettings, ArrowProjectileSettings, GrenadeSettings, GeneralProjectileSettings, BulletProjectileSettings, AerialProjectileSettings, GroundProjectileSettings, BarrageProjectileSettings, TeleportSettings, HomingSettings, TargetTypeSettings, 
            SpreadSettings, ColliderSettings, CreateSettings, ChargeSettings, AreaOfEffectSettings, DamageSettings, StunnedSettings, HealingSettings, KnockbackSettings, SlowedSettings;
        ...
        string SlowedSettingsTooltip = "Allows abilities the chance to slow a successfully hit target.";
        ...
        void OnEnable()
        {
            ...
            SlowedSettings = serializedObject.FindProperty("SlowedSettings");
        ...
        void DerivedSettings(EmeraldAbilityObject self)
        {
            ...
            if (DerivedSettingsFoldout.boolValue)
            {
                ...
                if (SlowedSettings != null) DrawModule(SlowedSettings, "Slowed Module", SlowedSettingsTooltip);
