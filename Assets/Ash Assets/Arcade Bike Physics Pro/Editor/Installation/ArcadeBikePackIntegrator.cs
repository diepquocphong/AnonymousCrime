...
public static class ArcadeBikePackIntegrator
{
    ...
    private const string SkidmarkPrefabPath = ArcadeRoot + "/Prefabs/Effects/SkidmarkController.prefab";
    private const string TireSmokePrefabPath = ArcadeRoot + "/Prefabs/Effects/TireSmoke.prefab";
    private const string ZeroFrictionMaterialPath =
        ArcadeRoot + "/Materials/Physics/ZeroFriction.physicMaterial";
    private const string EngineClipPath = ArcadeRoot + "/Audio/Engine/MotocrossEngine.wav";
    private const string GearClipPath = ArcadeRoot + "/Audio/Transmission/GearShift.wav";
    private const string SkidClipPath = ArcadeRoot + "/Audio/Tires/TireSkidLoop.wav";
    private const string EntryAnimationPath =
        "Assets/Ash Assets/Vehicle Integration/Vehicles/Bike/Animations/Character_Enter_Bike.anim";
    private const string MirroredEntryAnimationPath =
        ArcadeRoot + "/Animations/Entry/BikeEnter_Mirrored.anim";
    private const string RearBrakeFlareDataPath =
        ArcadeRoot + "/Data/Lighting/BrakeReverseFlare.asset";
    ...
    private static void TryAutoIntegrate()
    {
        ...
        if (!AllPrefabsExist() ||
            AssetDatabase.LoadAssetAtPath<MonoScript>(
                ArcadeRoot + "/Scripts/Core/ArcadeBikeControllerPro.cs"
            ) == null)
        {
            return;
        }
    ...
    {
        EnsureAssetFolder(ArcadeRoot, "Data");
        EnsureAssetFolder(ArcadeRoot + "/Data", "Lighting");
    ...
    private static void EnsureMirroredEntryAnimation()
    {
        ...
        EnsureAssetFolder(ArcadeRoot, "Animations");
        EnsureAssetFolder(ArcadeRoot + "/Animations", "Entry");
        ...
        mirrored.name = "BikeEnter_Mirrored";
