    ...
    public class SVP_ProjectSettings : EditorWindow
    {
        ...
        public class ImportAssetPrompt : AssetPostprocessor
        {
            private static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
            {
                ...
                {
                    if (assetPath.Contains("Assets/Ash Assets/Vehicle Integration/ThirdParty/Sim-Cade Vehicle Physics/Project Settings Presets")) // Adjust to match your asset's folder
                    {
                        ShowWindow();
                        break;
                    }
        ...
        {
            ApplyPreset("Assets/Ash Assets/Vehicle Integration/ThirdParty/Sim-Cade Vehicle Physics/Project Settings Presets/InputManager.preset", "ProjectSettings/InputManager.asset");
            ApplyPreset("Assets/Ash Assets/Vehicle Integration/ThirdParty/Sim-Cade Vehicle Physics/Project Settings Presets/PhysicsManager.preset", "ProjectSettings/DynamicsManager.asset");
            ApplyPreset("Assets/Ash Assets/Vehicle Integration/ThirdParty/Sim-Cade Vehicle Physics/Project Settings Presets/TimeManager.preset", "ProjectSettings/TagManager.asset");
