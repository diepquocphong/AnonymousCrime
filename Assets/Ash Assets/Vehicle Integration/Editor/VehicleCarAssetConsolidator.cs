...
{
    /// <summary>
    /// One-time, GUID-preserving migration of the active Car integration and its
    /// authored assets into a single documented root. Shared Bike/Player assets
    /// deliberately stay outside Car.
    /// </summary>
    public static class VehicleCarAssetConsolidator
    {
        public const string IntegrationRoot =
            "Assets/Ash Assets/Vehicle Integration";
        public const string CarRoot = IntegrationRoot + "/Car";
        ...
        private static void ValidateConsolidatedAssets(bool logSuccess)
        {
            string[] requiredPaths =
            {
                ...
                CarRoot + "/VFX/Hovl Studio/3D Fire and Explosions/Prefabs/Smoke1.prefab",
                CarRoot + "/VFX/Hovl Studio/3D Fire and Explosions/Prefabs/Fire3.prefab",
                CarRoot + "/VFX/Hovl Studio/3D Fire and Explosions/Prefabs/Explosion11.prefab",
                ...
                CarRoot + "/UI/Generated/RadioDisc.png",
                CarRoot + "/UI/Generated/RadioPower.png",
                CarRoot + "/UI/Generated/RadioPrevious.png",
                CarRoot + "/UI/Generated/RadioPlay.png",
                CarRoot + "/UI/Generated/RadioNext.png",
                CarRoot + "/UI/Generated/VehicleHealthFrame.png",
                CarRoot + "/Visuals/Models/Car.FBX",
