...
public class Aircraft : MonoBehaviour 
{
	...
	void Start() 
    {
	    ...
	    carMotor = gameObject.GetComponent<CarMotor>();
	...
	void FixedUpdate()
    {
        ...
        Debug.DrawLine(transform.position+transform.forward*5.0f,transform.position+transform.forward*5.0f+velocityDirection.normalized);
        ...
        {
            carMotor.body.AddForce(transform.up*4000.0f*carMotor.velocity+transform.up);
            carMotor.body.AddRelativeTorque(-10000.0f,0.0f,0.0f);
        }
        if(carMotor.velocity<0.01f) carMotor.parked=true;
