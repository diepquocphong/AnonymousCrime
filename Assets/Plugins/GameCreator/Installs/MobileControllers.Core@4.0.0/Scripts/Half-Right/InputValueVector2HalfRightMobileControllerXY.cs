...
{
    [Title("Half-Right Touch For Mobile (Invert X and Y)")]
    [Category("Mobile Controller/Camera/Half-Right/Half-Right Touch For Mobile (Invert X and Y)")]
    ...
    public class InputValueVector2HalfRightMobileControllerXY : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
