...
{
    [Title("Half-Left Touch For Mobile (Invert Y)")]
    [Category("Mobile Controller/Camera/Half-Left/Half-Left Touch For Mobile (Invert Y)")]
    ...
    public class InputValueVector2HalfLeftMobileControllerY : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
