...
{
    [Title("Half-Left Touch For Mobile")]
    [Category("Mobile Controller/Camera/Half-Left/Half-Left Touch For Mobile")]
    ...
    [Serializable]
    public class InputValueVector2HalfLeftMobileController : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
