...
{
    [Title("Half-Left Touch For Mobile (Invert X)")]
    [Category("Mobile Controller/Camera/Half-Left/Half-Left Touch For Mobile (Invert X)")]
    ...
    public class InputValueVector2HalfLeftMobileControllerX : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
