...
{
    [Title("Half-Left Touch For Mobile (Invert X and Y)")]
    [Category("Mobile Controller/Camera/Half-Left/Half-Left Touch For Mobile (Invert X and Y)")]

    [Description("Half-Left Touch For Mobile commonly used to orbit the camera around the main character")]
    ...
    public class InputValueVector2HalfLeftMobileControllerXY : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
