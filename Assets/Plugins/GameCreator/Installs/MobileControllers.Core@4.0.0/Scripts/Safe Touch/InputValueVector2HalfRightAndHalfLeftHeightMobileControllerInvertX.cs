...
{
    [Title("Safe Touch For Mobile (Invert X)")]
    [Category("Mobile Controller/Camera/Safe Touch/Safe Touch For Mobile (Invert X)")]
    ...
    [Serializable]
    public class InputValueVector2HalfRightAndHalfLeftHeightMobileControllerInvertX : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
