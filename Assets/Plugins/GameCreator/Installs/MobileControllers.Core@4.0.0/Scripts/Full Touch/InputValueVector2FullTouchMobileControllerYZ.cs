...
{
    [Title("Full Touch For Mobile (Invert X and Y)")]
    [Category("Mobile Controller/Camera/Full Touch/Full Touch For Mobile (Invert X and Y)")]
    ...
    [Serializable]
    public class InputValueVector2FullTouchMobileControllerYZ : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
