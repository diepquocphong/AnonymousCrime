...
namespace GameCreator.Runtime.Common
{
    ...
    [Category("Mobile Controller/Inventory/Tooltips/Touch Position")]

    [Description("This is only for inventory ui bag tooltips input.")]
    [Image(typeof(IconCursor), ColorTheme.Type.Yellow)]

    [Keywords("Touch", "Location", "Move", "Pan")]

    [Serializable]

    public class InputValueVector2TouchPosition : TInputValueVector2
    {
