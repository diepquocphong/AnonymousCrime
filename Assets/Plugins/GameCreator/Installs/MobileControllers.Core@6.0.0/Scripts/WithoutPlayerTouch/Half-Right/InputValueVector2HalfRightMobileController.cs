...
{
    [Title("Half-Right Touch For Mobile")]
    [Category("Mobile Controller/Camera/Half-Right/Half-Right Touch For Mobile")]
    ...
    [Serializable]
    public class InputValueVector2HalfRightMobileController : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
