...
{
    [Title("Half-Right Touch For Mobile (Invert X)")]
    [Category("Mobile Controller/Camera/Half-Right/Half-Right Touch For Mobile (Invert X)")]
    ...
    public class InputValueVector2HalfRightMobileControllerX : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
