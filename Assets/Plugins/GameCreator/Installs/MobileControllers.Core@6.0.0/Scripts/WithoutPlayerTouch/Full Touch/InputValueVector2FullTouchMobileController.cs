...
{
    [Title("Full Touch For Mobile")]
    [Category("Mobile Controller/Camera/Full Touch/Full Touch For Mobile")]
    ...
    [Serializable]
    public class InputValueVector2FullTouchMobileController : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
