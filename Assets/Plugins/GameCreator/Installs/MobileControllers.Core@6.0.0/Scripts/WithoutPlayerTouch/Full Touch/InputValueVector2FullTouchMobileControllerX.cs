...
{
    [Title("Full Touch For Mobile (Invert X)")]
    [Category("Mobile Controller/Camera/Full Touch/Full Touch For Mobile (Invert X)")]
    ...
    public class InputValueVector2FullTouchMobileControllerX : TInputValueVector2
    {
