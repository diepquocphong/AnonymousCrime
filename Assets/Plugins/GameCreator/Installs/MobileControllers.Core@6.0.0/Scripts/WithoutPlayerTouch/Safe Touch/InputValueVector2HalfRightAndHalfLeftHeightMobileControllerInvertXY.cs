...
{
    [Title("Safe Touch For Mobile (Invert X and Y)")]
    [Category("Mobile Controller/Camera/Safe Touch/Safe Touch For Mobile (Invert X and Y)")]
    ...
    [Serializable]
    public class InputValueVector2HalfRightAndHalfLeftHeightMobileControllerInvertXY : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
