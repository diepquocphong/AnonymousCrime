...
{
    [Title("Safe Touch For Mobile (Invert Y)")]
    [Category("Mobile Controller/Camera/Safe Touch/Safe Touch For Mobile (Invert Y)")]
    ...
    public class InputValueVector2HalfRightAndHalfLeftHeightMobileControllerInvertY : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
