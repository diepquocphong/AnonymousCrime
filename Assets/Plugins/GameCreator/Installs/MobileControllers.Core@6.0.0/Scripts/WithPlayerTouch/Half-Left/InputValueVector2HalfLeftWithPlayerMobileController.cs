...
{
    [Title("Half-Left Touch For Mobile (With Player)")]
    [Category("Mobile Controller/Camera/With Player (NEW)/Half-Left/Half-Left Touch For Mobile (With Player)")]

    [Description("Half-Left Touch For Mobile (With Player) commonly used to orbit the camera around the main character")]
    ...
    public class InputValueVector2HalfLeftWithPlayerMobileController : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
            ...
            get
            {
                if (this.m_InputAction == null)
                {
                    this.m_InputAction = new InputAction(
                        "Half-Left Touch For Mobile (With Player)",
