...
{
    [Title("Half-Right Touch For Mobile (With Player)")]
    [Category("Mobile Controller/Camera/With Player (NEW)/Half-Right/Half-Right Touch For Mobile (With Player)")]

    [Description("Half-Right Touch For Mobile (With Player) commonly used to orbit the camera around the main character")]
    ...
    public class InputValueVector2HalfRightWithPlayerMobileController : TInputValueVector2
    {
        // MEMBERS: -------------------------------------------------------------------------------
            ...
            get
            {
                if (this.m_InputAction == null)
                {
                    this.m_InputAction = new InputAction(
                        "Half-Right Touch For Mobile (With Player)",
