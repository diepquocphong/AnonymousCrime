...
namespace GameCreator.Editor.Inventory.UnityUI
{
    ...
    public class RuntimeItemUIDrawer : TItemUIDrawer
    {
        ...
        protected override void AddAfter(VisualElement root, SerializedProperty property)
        {
            ...
            SerializedProperty cooldownRemaining = property.FindPropertyRelative("m_CooldownRemaining");
            SerializedProperty cooldownRemainingFormat = property.FindPropertyRelative("m_CooldownRemainingFormat");
            ...
            root.Add(new PropertyField(cooldownRemaining));
            root.Add(new PropertyField(cooldownRemainingFormat));
        }
    }
}
