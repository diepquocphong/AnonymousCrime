...
namespace GameCreator.Runtime.Inventory.UnityUI
{
        ...
        IEndDragHandler
    {
        ...
        [SerializeField] private EnumOnDrop m_OnDrop = EnumOnDrop.MoveCombine;
        ...
        public void OnEndDrag(PointerEventData data)
        {
            ...
            if (this.Cell?.RootRuntimeItem != null)
            {
                ...
                {
                    data.Use();
                    EventSystem.current.SetSelectedGameObject(data.pointerCurrentRaycast.gameObject, data);
                }   
            }
        ...
        {
            bool isDragging = this.Cell == dragCellUI.Cell && this.Cell?.RootRuntimeItem != null;
        ...
        internal bool OnDropCellUI(BagCellUI dropCellUI)
        {
            ...
            return this.m_OnDrop switch
            {
                ...
                EnumOnDrop.MoveCombine => content.Combine(dropCellUI.Position, this.Position) ||
                                          content.Move(dropCellUI.Position, this.Position, true),
                _ => throw new ArgumentOutOfRangeException()
            };
        }
