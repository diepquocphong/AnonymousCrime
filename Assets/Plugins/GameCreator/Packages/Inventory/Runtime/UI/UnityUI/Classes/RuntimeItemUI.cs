...
namespace GameCreator.Runtime.Inventory.UnityUI
{
    ...
    public class RuntimeItemUI : TItemUI
    {
        ...
        [SerializeField] private TextReference m_CooldownRemaining = new TextReference();
        [SerializeField] private string m_CooldownRemainingFormat = "{0:0.00}";
        ...
        public void RefreshCooldown(Bag bag, Item item)
        {
            ...
            this.m_CooldownRemaining.Text = cooldown != null
                ? string.Format(this.m_CooldownRemainingFormat, cooldown.RemainingTime)
                : string.Empty;
        }
