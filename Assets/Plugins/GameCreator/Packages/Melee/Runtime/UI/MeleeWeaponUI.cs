...
{
    [Icon(EditorPaths.PACKAGES + "Melee/Editor/Gizmos/GizmoMeleeWeaponUI.png")]
    [DefaultExecutionOrder(ApplicationManager.EXECUTION_ORDER_LAST_LATER)]
    
    [AddComponentMenu("Game Creator/UI/Melee/Melee Weapon UI")]
    [Serializable]
    public class MeleeWeaponUI : MonoBehaviour
    {
        // EXPOSED MEMBERS: -----------------------------------------------------------------------
        ...
        private void Update()
        {
            ...
            if (character != null)
            {
                weapon = character.Combat.GetActiveWeapon<MeleeWeapon>();
