...
namespace Niam.Runtime.Tactile
{
    ...
    [Category("Tactile/Analog Stick/Set Input Simulate")]
    [Description("Overrides the control path of an Analog Stick's Input Simulate")]
    ...
    [Serializable]
    public class InstructionTactileSetStickInputSimulate : Instruction
    {
        // MEMBERS: -------------------------------------------------------------------------------
        ...
        protected override Task Run(Args args)
        {
            ...
            if (control != null && control.ControlType is TStickType stick) 
            {
                stick.InputSimulate.OverrideControlPath(this.m_ControlPath);
            }
