...
namespace Niam.Runtime.Tactile
{
    ...
    [Description("Gets the value of a Steering Wheel")]
    
    [Image(typeof(IconSteerWheel))]
    [Keywords("Tactile")]
    
    [Serializable]
    public class GetDecimalTactileSteerMotion : PropertyTypeGetDecimal
    {
        // MEMBERS: -------------------------------------------------------------------------------
        ...
        public override string String => $"{this.m_TactileControl}.SteerMotion";
        ...
        public override double Get(Args args)
        {
            ...
            {
                return steeringWheel.SteerMotion;
            }
