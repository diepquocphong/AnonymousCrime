...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    public class BaseNodeView : NodeView
    {
        ...
        public void Initialize(BaseGraphView owner, BaseNode node)
        {
            ...
            Selection.selectionChanged += UpdateExecutionStateView;
        ...
        public void ToggleExecutionState()
        {
            ...
            {
                var runner = Selection.activeGameObject.Get<StateMachineRunner>();
        ...
        protected void Highlight(GameObject context)
        {
            ...
            var enableHighlight = Selection.count == 0 || Selection.Contains(context);
            highLight.SetEnabled(enableHighlight);
        }

        protected void UnHighlight(GameObject context, bool runningResult)
        {
            CheckHighlightElement();
        ...
        protected virtual void DrawDefaultInspector(bool fromInspector = false)
        {
            ...
            {
                AddControlField(networkingField, "Networking Settings", false);
            }
        }
        ...
        protected SerializedProperty FindSerializedProperty(string fieldName)
        {
            ...
            return i >= array.arraySize ? null : array.GetArrayElementAtIndex(i).FindPropertyRelative(fieldName);
        }
