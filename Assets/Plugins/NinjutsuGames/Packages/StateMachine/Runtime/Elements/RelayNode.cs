...
{
    [Serializable]
    public class RelayNode : BaseGameCreatorNode
    {
        ...
        [HideInInspector] public bool unpackOutput;
        [HideInInspector] public bool packInput;
        public override bool hideControls => true;
        public override bool useNetwork => false;

        public int inputEdgeCount = 0;
        [System.NonSerialized] int outputIndex = 0;
        ...
        protected override void Process(GameObject newContext, Args customArgs = null)
        {
            ...
            if (Application.isPlaying && CanExecute(newContext))
            {
