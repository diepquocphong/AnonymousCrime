...
public class PhysicsBikeControllerEditor : Editor
{
    public override VisualElement CreateInspectorGUI()
    {
        ...
        StyleSheet styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Plugins/RVRGaming/RapidTemplate/Scripts/Editor/RapidEditorStyle.uss");
        ...
        {
            image = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Plugins/RVRGaming/RapidTemplate/UI/Bike.png")
        };
        ...
        root.Add(unitySpacer);
        root.Add(Make("Leaning", false, new[] { "leanTorque", "maxLeanAngle", "leanSpeedThreshold" }));
        root.Add(unitySpacer);
