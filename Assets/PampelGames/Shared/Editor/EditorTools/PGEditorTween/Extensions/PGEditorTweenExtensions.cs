...
namespace PampelGames.Shared.Editor.EditorTools
{
    ...
    public static class PGEditorTweenExtensions
    {
        ...
        public static void Stop(this PGEditorTweenDescr tween)
        {
            tween.internalEvents.onStop?.Invoke();
            tween.stopped = true;
        }
        ...
        public static void OnStop(this PGEditorTweenDescr tween, Action action)
        {
            tween.internalEvents.onStop = action;
        }
