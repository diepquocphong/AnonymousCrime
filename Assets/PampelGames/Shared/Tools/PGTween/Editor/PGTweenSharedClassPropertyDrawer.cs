...
namespace PampelGames.Shared.Tools.Editor
{
    ...
    public class PGTweenSharedClassPropertyDrawer : PropertyDrawer
    {
        ...
        // Curve Creator
        private readonly ToolbarToggle showPresetsToggle = new();
        ...
        {
            animationCurve.value = PGTweenAnimationCurvesUtility.CreateShakeCurve(maxPositive.value, maxNegative.value, shakeFrequency.value, multiplier.value, flip.value);
        }
