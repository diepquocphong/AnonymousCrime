...
{
    [CustomPropertyDrawer(typeof(PGExecuteGetButtonUp))]
    public class PGExecuteGetButtonUpPropertyDrawer : PropertyDrawer
    {
        ...
        {
            buttonNameProperty = property.FindPropertyRelative(nameof(PGExecuteGetButtonUp.buttonName));
