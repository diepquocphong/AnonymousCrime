...
{
    [CustomPropertyDrawer(typeof(PGStopGetKeyUp))]
    public class PGStopGetKeyUpPropertyDrawer : PropertyDrawer
    {
        ...
        {
            keyCodeProperty = property.FindPropertyRelative(nameof(PGStopGetKeyUp.keyCode));
