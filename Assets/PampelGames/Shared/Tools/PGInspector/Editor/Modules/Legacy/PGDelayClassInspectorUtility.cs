...
{
    /// <summary>
    ///     Static helper methods for MonoBehaviour Inspectors that implement <see cref="PGDelayClassBase" />.
    /// </summary>
    public static class PGDelayClassInspectorUtility
    {
        ...
        public static void AddDelayClassTypes(Assembly[] assemblies, List<PGDelayClassBase> delayClassBaseList, List<string> delayClassBaseStringList)
        {
            ...
            foreach (var delayClassBase in delayClassBaseList) delayClassBaseStringList.Add(delayClassBase.ModuleName());
        }
        ...
        ///     <see cref="PGDelayClassBaseInspectorUtility.AddDelayClassTypes" />
        /// </param>
            ...
            DropdownField addDelayDropdown, List<PGDelayClassBase> delayClassBaseList, VisualElement visualElementParent, int parentInsertIndex)
        {
            ...
            void BindItem(VisualElement itemWrapper, int i)
            {
                ...
                itemLabel.text = "Delay: " + baseComponentDelayClassBaseList[i].ModuleName();
                itemLabel.tooltip = baseComponentDelayClassBaseList[i].ModuleInfo();
