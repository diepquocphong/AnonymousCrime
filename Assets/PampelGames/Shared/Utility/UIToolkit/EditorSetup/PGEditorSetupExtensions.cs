...
namespace PampelGames.Shared.Utility
{
    public static class PGEditorSetupExtensions
    {
        ...
        ///     Note that the ListView may still need to be Binded!
        /// </summary>
        ...
        public static void PGSetupObjectListViewEditor<T>(this ListView listView, List<T> objectList) where T : Object
        {
            ...
            listView.bindItem = (element, i) =>
            {
                ...
                field.RegisterValueChangedCallback(evt => { objectList[i] = evt.newValue as T; });
            };
        }

        /// <summary>
        ///     Sets up an ListView, either Object (ObjectField) or Class (PropertyField).
        ///     Note that the ListView may still need to be Binded!
        /// </summary>
        public static void PGSetupListViewEditor(this ListView listView, SerializedProperty listProperty, IList list)
        {
            ...
            if (typeof(Object).IsAssignableFrom(itemType))
            {
                listView.makeItem = () =>
                {
                    var item = new VisualElement();
                ...
                {
                    var field = element.Q<ObjectField>();
                    field.value = list[i] as Object;
                    field.RegisterValueChangedCallback(evt => { list[i] = evt.newValue; });
                };
            }
            else
            {
                ...
                listView.bindItem = (element, i) =>
                {
                    ...
                    field.BindProperty(listProperty.GetArrayElementAtIndex(i));
                };
            }
        }
