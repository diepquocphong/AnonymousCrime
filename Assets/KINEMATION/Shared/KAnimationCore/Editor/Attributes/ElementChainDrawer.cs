    ...
    public class ElementChainDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (rig != null)
            {
                ...
                bool hasUserSelection = elementChain.arraySize > 0;
                if (hasUserSelection)
                {
                    buttonRect.width -= EditorGUIUtility.singleLineHeight + ClearButtonSpacing;
                }
                ...
                if (hasUserSelection)
                {
                    ...
                    clearButtonContent.tooltip = "Clear chain selection";
